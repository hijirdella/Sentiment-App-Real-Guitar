...
model = joblib.load('XGBoost_Original_model_Real_Guitar.pkl')
vectorizer = joblib.load('tfidf_vectorizer_Real_Guitar.pkl')
label_encoder = joblib.load('label_encoder_Real_Guitar.pkl')
...
# === Judul Aplikasi ===
st.title("🎸 Aplikasi Analisis Sentimen – Real Guitar")
    ...
    if st.button("🚀 Prediksi Sentimen"):
        if user_review.strip() == "":
            ...
            st.download_button(
                ...
                data=csv_manual,
                file_name="hasil_prediksi_manual_real_guitar.csv",
                mime="text/csv"
            )
        ...
        try:
            ...
            if not required_cols.issubset(df.columns):
                ...
                st.download_button(
                    ...
                    data=csv_result,
                    file_name="hasil_prediksi_real_guitar.csv",
                    mime="text/csv"
                )
